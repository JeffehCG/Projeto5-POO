...
<html>
    ...
    <body>
        ...
        <div style="align-self: center" class="header-novo-cadastro">
                <p>LISTA DE SAIDAS</p>
                <span>Forneça as informações sobre as saidas de mercadoria.</span>
            </div>
        <div class="container pesquisa">
            ...
            <%
                try{
                for(int i = 0 ; i<SaidaProduto.getStayList().size();i++){
                 SaidaProduto lista = SaidaProduto.getStayList().get(i);
            %>
                <tr>
                    <td><%=lista.getCpf()%></td>
                    <td><%=lista.getDataSaida()%></td>
